...
// +kubebuilder:rbac:groups=mongodb.shippercd.io,resources=mongodbdatabases/finalizers,verbs=update
...
func (r *MongodbDatabaseReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&mongodbv1alpha1.MongodbDatabase{}).
		Named("mongodb-mongodbdatabase").
		Complete(r)
}
